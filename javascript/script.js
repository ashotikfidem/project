...
var cardSwiper = new Swiper(".cardSwiper", {
  ...
  var cardSwiper2 = new Swiper(".cardSwiper2", {
	navigation: {
...
var salesHits = new Swiper(".js-sales-hits", {
	slidesPerView: 4,
	// spaceBetween: 30,
	loop: true,
	breakpoints: {
  ...
  const jsHits =  document.getElementById("jsHits");
  if(jsHits){
	  salesHits.el.parentElement.querySelector(".swiper-sales-hits-arrows-next").addEventListener('click',
	  () => salesHits.slideNext());
	  salesHits.el.parentElement.querySelector(".swiper-sales-hits-arrows-prev").addEventListener('click',
	  () => salesHits.slidePrev());
  }
...
rangeslider = document.querySelector(".slider .progress");
let priceGap = 1000;
    ...
    input.addEventListener("input", e =>{
        ...
        if((maxPrice - minPrice >= priceGap) && maxPrice <= rangeInput[1].max){
            if(e.target.className === "input-min"){
                ...
                rangeslider.style.left = ((minPrice / rangeInput[0].max) * 100) + "%";
            }else{
                rangeInput[1].value = maxPrice;
                rangeslider.style.right = 100 - (maxPrice / rangeInput[1].max) * 100 + "%";
            }
        }
    });
});
...
rangeInput.forEach(input =>{
    input.addEventListener("input", e =>{
        ...
        if((maxVal - minVal) < priceGap){
            ...
            rangeslider.style.left = ((minVal / rangeInput[0].max) * 100) + "%";
            rangeslider.style.right = 100 - (maxVal / rangeInput[1].max) * 100 + "%";
        }
    });
});
...
for (const popup of popups) {
	popup.addEventListener("click", function (e) {
		e.preventDefault();
		let template = document.getElementById(this.dataset.popup).cloneNode(true);
		Swal.fire({
			template: template,
...
const chooseCityes = document.querySelectorAll(".--js--popup-city");


for (const city of chooseCityes) {
	city.addEventListener("click", function (e) {
		...
		Swal.fire({
			...
			width: 300,
      didOpen: () => {
        const chooseCityesbutton = document.getElementById("choose-city-swal2-confirm");
        chooseCityesbutton.addEventListener("click", function (e) {
          e.preventDefault();
          const chooseCityesTemplate = document.getElementById("choose-city");
          let template = chooseCityesTemplate.cloneNode(true);
          Swal.fire({
            template: template,
            showCloseButton: true,
            showConfirmButton: false,
...
const succeses = document.querySelectorAll(".--js--succes");
for (const succes of succeses) {
